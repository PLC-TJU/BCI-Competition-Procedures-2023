...
class TLEstimator(BaseEstimator):
    ...
    def fit(self, X, y_enc):
        ...
        if isinstance(self.estimator, Pipeline):
            ...
            for step in self.estimator.steps:
                step_name = step[0]
                if step_name not in ['lineardiscriminantanalysis','csp','dcpm','trca','mutualinformationselector']:#corey lin 2023.07.08
    ...
    def transform(self, X):  #corey lin 2023.07.09
        """Transform TLEstimator.
